 ...
 * (TipoDocReferenciaType and CodigoReferenciaType). See the ANEXOS Y
 * ESTRUCTURAS v4.4 document (Notas 9 and 10) for the authoritative
 * meaning of each code.
 *
 * Note: the April 2026 revision of v4.4 (mandatory 2026-11-01) adds
 * reference codes 13-17 and referenced-document types 19-20. They are
 * intentionally NOT included yet: the vendored base XSDs would reject
 * them. Add them when the revised XSDs are vendored (see
 * docs/specs/v4.4-compliance.md, Workstream 2).
 */
